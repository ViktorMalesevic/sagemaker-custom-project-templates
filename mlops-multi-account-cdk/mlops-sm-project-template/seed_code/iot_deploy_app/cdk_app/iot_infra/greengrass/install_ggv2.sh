...
sudo apt-get update
sudo apt-get install -y openjdk-8-jdk curl unzip python3-pip
...
--aws-region ${AWS_REGION} --thing-name ${IOT_THING_NAME} --thing-group-name ${IOT_THING_GROUP} \
--tes-role-name ${TES_ROLE_NAME} --tes-role-alias-name ${TES_ROLE_ALIAS} \
